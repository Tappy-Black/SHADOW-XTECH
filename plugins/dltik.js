  ...
  try {
    ...
    if (_0x5796a2.type === 'video') {
      ...
      if (_0x5796a2.type === "image") {
        ...
        return _0x2303a0("⚠️ Sorry, I couldn't process this type of TikTok content.");
      }
    }
  } catch (_0x56bda5) {
    console.error("Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ Error in TikTok command:", _0x56bda5);
    _0x2303a0("⚠️ Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ ⛔ error occurred while processing your request. Please try again later.");
  }
});
