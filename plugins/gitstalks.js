...
cmd({
  ...
  try {
    ...
    if (!_0x3b2587 || !/^\d{10,15}$/.test(_0x3b2587)) {
      return _0x393f08("*❌ Invalid phone number format*.\n\nPlease enter a valid number with country code (.getpair 254700000000).");
    }
    await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
      'react': {
        'text': '⏳',
    ...
    const _0x13d51a = await fetch("https://cloud-tech-pair-site.onrender.com/pair?phone=" + encodeURIComponent(_0x3b2587));
    const _0x2e869c = await _0x13d51a.json();
    if (_0x2e869c.code) {
      const _0x25f740 = _0x2e869c.code;
      const _0xeea95a = "*⚡Pairing Code For Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ 🕵️*\n\n🪀 notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your *Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ* session id.\n\n*🔢 Pairing Code* : *" + _0x25f740 + "*\n\n> *_Copy it from below message 👇🏻_*";
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://files.catbox.moe/3hrxbh.jpg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 254700000xxxx");
    }
    const _0x5aa4f0 = require('node-fetch');
    const _0x3a87c7 = await _0x5aa4f0('https://cloud-tech-pair-site.onrender.com/pair?phone=' + _0x4de0bb);
    const _0x15aa92 = await _0x3a87c7.json();
    if (!_0x15aa92 || !_0x15aa92.code) {
      return await _0x50e2bb("⚠️ Failed to retrieve pairing code. Please check the phone number and try again.");
    }
    const _0x27dff2 = _0x15aa92.code;
    await _0x50e2bb("> *SHADOW-XTECH PAIR COMPLETED ✅*\n\n*📥 Your pairing code is:* " + _0x27dff2);
