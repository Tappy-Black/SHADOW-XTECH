...
cmd(_0x235552, async (_0x5627f6, _0x3c9922, _0x196741, {
  ...
  try {
    console.log("🕵️ Attempting to fetch pending requests for group: " + _0x152438);
    const _0x1cec50 = await _0x5627f6.groupRequestParticipantsList(_0x152438);
    console.log(_0x1cec50);
    if (_0x1cec50.length > 0x0) {
      let _0x23374c = "🕵️ Pending Requests to Join the Group:\n";
      let _0x17317a = [];
...
cmd(_0x485005, async (_0x49ae26, _0xcdfa27, _0x2d27f9, {
  ...
  try {
    ...
    if (_0x495e05.length === 0x0) {
      return _0x2c52c1("🕵️ There are no pending requests to manage.");
    }
    let _0x1b4d8b = "🕵️ Pending Requests to Join the Group:\n";
    let _0x5bd4ee = [];
    let _0x701413 = [];
...
cmd(_0x3bcce0, async (_0x4981f9, _0x1ac44e, _0x59ef0d, {
  ...
  if (_0x2c3dbc === 'on') {
    ...
    const _0x4b59f0 = {
      'text': "🕵️ Disappearing messages are now ON for " + _0x1d6174 + '.'
    };
    ...
    if (_0x2c3dbc === "off") {
      ...
      const _0x3b5871 = {
        'text': "🕵️ Disappearing messages are now OFF."
      };
