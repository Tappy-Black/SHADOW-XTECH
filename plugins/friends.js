...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "254759000340@s.whatsapp.net", // Replace with staff contact numbers
                "254759000340@s.whatsapp.net", // Example: Add staff members here
                "254759000340@s.whatsapp.net", // Example: Add staff members here
                "254759000340@s.whatsapp.net", // Example: Add staff members here
                "254759000340@s.whatsapp.net", // Example: Add staff members here
                "254759000340@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ𓆪";
            const imageUrl = "https://files.catbox.moe/3hrxbh.jpg"; // Replace with the actual image URL
